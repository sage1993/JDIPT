...
def register_material_proposition(
    ...
    return {
        ...
        "activation_state": result.state.activation_state,
        "registry_required": result.state.registry_required,
        "registry_completed": result.state.registry_completed,
        "registry_required_operations": list(result.state.registry_required_operations),
        "registry_invocation_count": result.state.registry_invocation_count,
        "registry_enforcement_count": result.state.registry_enforcement_count,
